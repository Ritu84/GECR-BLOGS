...
import NotificationCommentField from "../components/notification-comment-field.component";
...
const NotificationCard = ({data, index, notificationState}) => {
  ...
  let {type,reply,createdAt,comment,seen,replied_on_comment,user,user:{personal_info:{fullname,username,profile_img}},blog:{_id,blog_id,title},_id:notification_id} = data;
        ...
        }
        {
            ...
            <div className='ml-20 p-5 bg-grey mt-5 rounded-md'>
                <div className='flex gap-3 mb-3'>
                    <img  src={author_profile_img} className='w-8 h-8 rounded-full'  alt="Profile"/>
                ...
                <button className='ml-14 mt-2 underline hover:text-black'onClick={(e)=>handleDelete(reply._id,'comment', e.target)}>Delete</button>
