...
const handleLike=()=>{
     if(access_token){ //like the blog as logged in
    ...
    <Toaster/>
       ...
       <div className='flex gap-6 justify-between'>
          ...
          <div className='flex gap-6 items-center'>
            ...
            <Link to={`https://twitter.com/intent/tweet?text=Read ${title}&url=${location.href}`} target='_blank'><i className="fi fi-brands-twitter text-xl hover:text-twitter "></i>
            </Link>
