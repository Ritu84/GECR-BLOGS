    ...
    <div className='flex gap-10 border-b mb-6 max-md:px-4 border-grey pb-6 items-center'>
      ...
      <div className='flex flex-col justify-between py-2 w-full min-w-[300px]'>
         ...
         <div className='flex gap-6 mt-3'>
          ...
          <button className='lg:hidden pr-4 p-2 underline' onClick={()=>setShowStat(val=>!val)}>Stats</button>
...
const deleteBlog =(blog,access_token,target)=>{
  ...
  .then(({data})=>{
    ...
    setStateFunc(oldData=>{

      let {deletedDocCount,totalDocs,results} = oldData;
      ...
      console.log({...oldData,totalDocs:totalDocs-1,deleteDocCount:deletedDocCount+1}) 
      return {...oldData,totalDocs:totalDocs-1,deleteDocCount:deletedDocCount+1}
    })
  })
  .catch(err=>{
    console.log(err)
