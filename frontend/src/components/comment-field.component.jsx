...
const CommentField = ({action, index=undefined,replyingTo=undefined,setReplying }) => {
    ...
    const handleClick=()=>{
         ...
         axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/add-comment",{_id,comment,blog_author,replying_to:replyingTo},{
            headers:{
  ...
  return (
    <>
       ...
       className='input-box pl-5 placeholder:text-dark-grey resize-none
       h-[150px] overflow-auto'></textarea>
       <button className='btn-dark mt-5 px-10' onClick={handleClick}>{action}</button>
    </>
  )
}
