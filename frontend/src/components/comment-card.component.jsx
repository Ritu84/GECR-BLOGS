...
const CommentCard = ({index, leftVal,commentData }) => {
  ...
  let {blog,blog:{comments,activity,activity: {total_parent_comments},
     comments:{results:commentsArr} ,author:{personal_info:{username: blog_author} }},setBlog, setTotalParentCommentsLoaded} = useContext(BlogContext)
...
const removeCommentsCards=(startingPoint, isDelete=false)=>{
  if(commentsArr[startingPoint])
   ...
   if(commentData.childrenLevel==0 && isDelete){
    setTotalParentCommentsLoaded(val=>val-1)
   }
  ...
  return (
    <div className='w-full' style={{paddingLeft: `${leftVal*10}px`}}>
        <div className='my-5 p-6 riunded-md border border-grey'>
