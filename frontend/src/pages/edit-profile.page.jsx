...
const EditProfile = () => {
  ...
  const handleSubmit=(e)=>{
    ...
    axios.post(import.meta.env.VITE_SERVER_DOMAIN+ "/update-profile",{username,bio,social_links:{youtube,instagram,facebook,github,website,twitter}},{
        headers:{
            'Authorization' :  `Bearer ${access_token}`
        }
    })
                ...
                <div className='flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10'>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 md:gap-5'>
                          ...
                          <div>
                            <InputBox name="email" type="email" value={email}  placeholder="Email" disable={true} icon =
                            "fi-rr-envelope" />
                          </div>
                        </div>
                        ...
                        <textarea
                          ...
                          maxLength={bioLimit}
                          defaultValue={bio}
                          className='input-box h-64 lg:h-40 resize-none leading-7mt-5 pl-5'
                          placeholder='Bio'
                       ...
                       <button 
                       className='btn-dark w-auto px-10' type="submit" onClick={handleSubmit}>Update</button>
                    </div>
